    ...
    TransactionExecution *txm)
{
    ...
    sk_encoder_vec.reserve(new_indexes_name_.size());
    ...
    do
    {
        ...
        for (auto index_it = new_indexes_name_.cbegin();
             index_it != new_indexes_name_.cend();
             ++index_it)
        {
            size_t vec_idx = index_it - new_indexes_name_.cbegin();
